...
: Unit: microseconds
:                                                                                                  expr
:  {     set.seed(12345)     sim = new("illness_death", debug = FALSE)     for (i in 1:100) sim$run() }
:                                    {     set.seed(12345)     call_illness_death(100, debug = FALSE) }
:        min         lq       mean     median        uq        max neval cld
:  82603.413 83735.2110 86391.8281 84988.7705 86449.842 185751.227   100   b
:    425.731   440.7475   502.4519   467.3505   540.629   1403.868   100  a
...
|---+---------------------------------------------------------------------------------------+-----------+-----------+-----------+-----------+-----------+-----------+--------+-----|
| 1 | {     set.seed(12345)     sim = new("simple_person")     for (i in 1:100) sim$run() } | 102370.65 | 103720.92 | 105976.17 | 104420.24 | 106384.88 | 201976.89 | 100.00 | b   |
| 2 | {     set.seed(12345)     callSimplePersonB(100) }                                    |    970.70 |   1010.23 |   1095.95 |   1061.87 |   1082.77 |   3269.92 | 100.00 | a   |
