 ...
 **/
  // typedef std::unary_function<const Event *,bool> EventPredicate;
  typedef std::tr1::function<bool (const Event *)> EventPredicate;
  // typedef bool (*EventPredicate)(const Event *);
