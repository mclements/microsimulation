...
*/
  inline int &counter_id() {static int counter_id_ = 0; return counter_id_; }
...
// IMPLEMENTATION - moved from microsimulation.cc
...
namespace ssim {
  ...
  inline Rng * default_stream() {static Rng default_stream_; return &default_stream_; }
  inline Rng * current_stream() {static Rng current_stream_; return &current_stream_; } // Is this instance ever used? Is this leaky?
  inline double * rn() { static double rn_ = 0.0; return &rn_; }
  ...
  // */
  //   inline void r_create_current_stream()
  //   {
  ...
  // */
  //   inline void r_remove_current_stream()
  //   {
  ...
  // */
  //   inline void r_set_user_random_seed(double * inseed) {
  ...
  //     @brief A utility function to set the user random seed for the simulation.
  // */
  //   inline void r_get_user_random_seed(double * outseed) {
  //     unsigned long seed[6];
  ...
  // */
  //   inline void r_next_rng_substream() {
  //     default_stream()->ResetNextSubstream();
  //   }
    
  //   inline double *user_unif_rand ()
  //   {
  //     if (!current_stream()) {
  ...
  // */
  //   inline void test_rstream2(double * x) {
  //     Rng * s1 = new Rng();
  //     Rng * s2 = new Rng();
  ...
  class RNGScope : public Rcpp::RNGScope {
  public:
    RNGScope() : Rcpp::RNGScope() {
      *current_stream() = *default_stream();
    }
    // static void force() {
    //   double seed[6];
