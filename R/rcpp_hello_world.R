...
FhcrcParameters <- list(
    ...
    hr_locoregional=transform(expand.grid(age=c(50,60,70),ext_grade=0:2,psa10=0:1),
                              hr=c(0.5862661, 1.0367450, 1.9028091, 2.7392712,
                                   3.3006610, 4.6482920, 1.2962081, 0.9303374,
                                   1.4387360, 1.4275195, 1.1170135, 1.2765646,
                                   2.6787924, 3.2410121, 2.3763680, 0.7463344,
                                   0.7508363, 0.7464595)),
...
plot.fhcrc <- function(x,
    ...
    if (is.null(ylab)) ylab <- switch(type, psa="PSA rates per 1000", biopsies="Biopsies per 1000", incidence="Prostate cancer incidence rates per 100,000", metastatic="Metastatic onset per 100,000", cancerdeath="Cancer mortality rates per 100,000",alldeath="All cause mortality rates per 100,000")
