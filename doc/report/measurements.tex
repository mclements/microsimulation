...
\begin{figure}[!htbp] \centering
  ...
  \label{fig:cppMot}
\end{figure}
We used Valgrind to profile the C++ function, ``\texttt{callFhcrc}'', that is
called in ``\texttt{.Call}'' from the R-side. Figure \ref{fig:cppMot} shows the
...
time is spent in the \texttt{EventReport::add} method function. This
